...
<!-- Modal -->
<div class="modal fade" id="crearEmpleado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" id="header-2">
                <h4 id="title" class="modal-title">NUEVO EMPLEADO</h4>
            ...
            <div class="modal-body">
                <form id="provee-form" method="POST" action="{{url('')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nomempleado" placeholder="Nombre del empleado">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="empleado">Guardar</button>
            </div>
        </div>
    </div>
</div>