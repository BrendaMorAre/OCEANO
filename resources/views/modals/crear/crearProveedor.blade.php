...
<div class="modal fade" id="crearProveedor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" id="header-4">
                <h4 id="title" class="modal-title">NUEVO PROVEEDOR</h4>
                ...
                <form id="provee-form" method="POST" action="{{url('')}}">
                    ...
                    <div class="form-group row">
                        <div class="col-xs-5 form-group">
                            <label style="margin-left: 8%" id="label" for="inputPassword3" class="col-sm-2 col-form-label">  Correo</label>
                            <div class="col-sm-9">
                                <input style="margin-left: 21%" type="text" class="form-control" id="provee-input" name="correo1" placeholder="Correo Principal">
                            </div>
                        </div>
                        <div class="col-xs-7 form-group">
                            <label id="label" for="inputPassword3" class="col-sm-4 col-form-label">Correo 2</label>
                            <div class="col-sm-6">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="proveedor">Guardar</button>
            </div>
        </div>
    </div>
</div>